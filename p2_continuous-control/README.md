...
We will solve the second version in this repository.

### Solving the Environment

Our agents must get an average score of +30 (over 100 consecutive episodes, and over all agents).  Specifically,
